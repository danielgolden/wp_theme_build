			...
			<div id="primary_col" class="blg_primary">
				<section class="blg_post">
					<?php if(have_posts()) : while ( have_posts()) : the_post(); ?>
						...
						<!--<p class="blg_post_meta">Posted November 29<sup>th</sup> , 2012</p>
						<a href="#"><img class="blg_post_img" src="images/temp/blog_post_image_1.jpg" alt="" /></a>
						<div class="blg_post_content">
							<p>
							Proin metus odio, aliquam eget molestie nec, gravida ut sapien. Phasellus quis est sed turpis sollicitudin venenatis sed eu odio. Praesent eget neque eu eros interdum malesuada non vel leo. Se fringilla porta ligula egestas tincidunt. Nullam risus. Pellentesque eu est a nulla placerat dignissim. Proin metus odio, aliquam eget molestie nec, gravida ut sapien. <a href="#">Phasellus</a> quis est sed turpis sollicitudin venenatis sed eu odio. Praesent eget neque eu eros interdum malesuada non vel ledor na fringilla porta ligula egestas tincidunt. Nullam risus. Pellentesque eu est a nulla placerat dignissim.
							</p>
							<p>Morbi euismod magna ac lorem rutrum elementum. Donec viverra auctor lobortis. Pellentesque eu est a nulla placerat.</p>
							<p>
						...
						<a href="#" class="button_1">Read More &raquo;</a>
				...
				<section class="blg_post">
					<h3 class="blg_post_title"><a href="#">Early to bed, early to rise</a></h3>
					<p class="blg_post_meta">Posted November 29<sup>th</sup> , 2012</p>
					<a href="#"><img class="blg_post_img" src="images/temp/blog_post_image_2.jpg" alt="" /></a>
					<div class="blg_post_content">
						<p>
						Proin metus odio, aliquam eget molestie nec, gravida ut sapien. Phasellus quis est sed turpis sollicitudin venenatis sed eu odio. Praesent eget neque eu eros interdum malesuada non vel leo. Se fringilla porta ligula egestas tincidunt. Nullam risus. Pellentesque eu est a nulla placerat dignissim. Proin metus odio, aliquam eget molestie nec, gravida ut sapien. <a href="#">Phasellus</a> quis est sed turpis sollicitudin venenatis sed eu odio. Praesent eget neque eu eros interdum malesuada non vel ledor na fringilla porta ligula egestas tincidunt. Nullam risus. Pellentesque eu est a nulla placerat dignissim.
						</p>
				...
				<section class="blg_post">
					<h3 class="blg_post_title"><a href="#">An interview with the founders of LA Fitness & Billy Blanks</a></h3>
					<p class="blg_post_meta">Posted November 29<sup>th</sup> , 2012</p>
					<a href="#"><img class="blg_post_img" src="images/temp/blog_post_image_3.jpg" alt="" /></a>
					<div class="blg_post_content">
						<p>
						Proin metus odio, aliquam eget molestie nec, gravida ut sapien. Phasellus quis est sed turpis sollicitudin venenatis sed eu odio. Praesent eget neque eu eros interdum malesuada non vel leo. Se fringilla porta ligula egestas tincidunt. Nullam risus. Pellentesque eu est a nulla placerat dignissim. Proin metus odio, aliquam eget molestie nec, gravida ut sapien. <a href="#">Phasellus</a> quis est sed turpis sollicitudin venenatis sed eu odio. Praesent eget neque eu eros interdum malesuada non vel ledor na fringilla porta ligula egestas tincidunt. Nullam risus. Pellentesque eu est a nulla placerat dignissim.
						</p>
						...
						<p>Morbi euismod magna ac lorem rutrum elementum. Donec viverra auctor lobortis. Pellentesque eu est a nulla placerat.</p>
						<p>
						Nulla fringilla, orci ac euismod semper, magna diam porttitor mauris, quis sollicitudin sapien justo in libero. Vestibulum mollis mauris enim. Morbi euismod magna ac lorem rutrum elementum. Donec viverra auctor lobortis. Pellentesque eu est a nulla placerat dignissim. Morbi a enim in magna semper bibendum. <a href="#">Etiam scelerisque</a>.
						</p>
					</div><!-- end .blg_post_content -->
					<a href="#" class="button_1">Read More &raquo;</a>
			...
			<aside id="secondary_col" class="blg_aside">
				...
				<section id="recent_videos" class="aside_module">
					...
					<div class="recent_video_preview group">
						<img src="images/temp/recent_videos_small_thumb_1.jpg" class="recent_video_preview_thumb" alt="Video Preview Thumbnail" />
						<h4 class="recent_video_preview_header">Aliquam erat volutpat mauris...</h4>
						<p class="date">11/3/11</p>
					</div>
					<div class="recent_video_preview group">
						<img src="images/temp/recent_videos_small_thumb_2.jpg" class="recent_video_preview_thumb" alt="Video Preview Thumbnail" />
					...
					<div class="recent_video_preview group">
						<img src="images/temp/recent_videos_small_thumb_3.jpg" class="recent_video_preview_thumb" alt="Video Preview Thumbnail" />
				...
				<section id="products_aside" class="aside_module">
					...
					<div class="product_preview group">
						<img src="images/temp/small_thumb_placeholder.jpg" class="product_preview_thumb" alt="Product Thumbnail" />
